...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const command = ffmpeg()
      ...
      .output("rtsp://localhost:8554/sdfsdf")
      ...
      .outputOptions(['-c:v', 'h264', '-preset', 'ultrafast', '-b:v', '3000k', '-framerate', '30', '-maxrate', '3000k', '-bufsize', '6000k', '-g', '50', '-c:a', 'aac', '-b:a', '128k', '-ac', '2', '-ar', '44100', '-threads', '0', '-s', '1920x1080'])
